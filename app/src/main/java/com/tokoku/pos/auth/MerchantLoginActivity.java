...
public class MerchantLoginActivity extends BaseAuthActivity implements LoginListener {
	...
	private void testGenExcel() {
		...
		try {
			...
			//file = File.createTempFile("report", ".xls", getExternalCacheDir());
			file = new File(getExternalCacheDir(), "report.xls");
		...
		try {
			...
			String to[] = {"enggarmanah@gmail.com"};
